...
export const TBattleEnemyFleet: MessageFns<TBattleEnemyFleet> = {
  ...
  fromJSON(object: any): TBattleEnemyFleet {
    return {
      ...
      Ships: globalThis.Array.isArray(object?.Ships) ? object.Ships.map((e: any) => TBattleEnemyShip.fromJSON(e)) : [],
    };
  },
...
export const TBattleEnemyShip: MessageFns<TBattleEnemyShip> = {
  ...
  fromJSON(object: any): TBattleEnemyShip {
    return {
      ...
      PSkill: globalThis.Array.isArray(object?.PSkill) ? object.PSkill.map((e: any) => globalThis.Number(e)) : [],
    };
  },
