...
function createBaseTBattleEquip(): TBattleEquip {
  return { EquipTid: 0, EquipIndex: 0, PlaneNum: 0, AttrValue: [], PSkillEquipList: [], PetId: 0 };
}
...
export const TBattleEquip: MessageFns<TBattleEquip> = {
  ...
  fromPartial<I extends Exact<DeepPartial<TBattleEquip>, I>>(object: I): TBattleEquip {
    ...
    message.PSkillEquipList = object.PSkillEquipList?.map((e) => TEquipPSkills.fromPartial(e)) || [];
...
export const TBattleExtraParam: MessageFns<TBattleExtraParam> = {
  ...
  fromJSON(object: any): TBattleExtraParam {
    return {
      ...
      isMultiFleet: isSet(object.isMultiFleet) ? globalThis.Boolean(object.isMultiFleet) : false,
...
export const TBattleFleet: MessageFns<TBattleFleet> = {
  ...
  fromJSON(object: any): TBattleFleet {
    return {
      ...
      Ships: globalThis.Array.isArray(object?.Ships) ? object.Ships.map((e: any) => TBattleShip.fromJSON(e)) : [],
      StrategyId: isSet(object.StrategyId) ? globalThis.Number(object.StrategyId) : 0,
      ...
      HeroList: globalThis.Array.isArray(object?.HeroList) ? object.HeroList.map((e: any) => globalThis.Number(e)) : [],
      TacticType: isSet(object.TacticType) ? globalThis.Number(object.TacticType) : 0,
    };
  },
...
export const TBattlePlayer: MessageFns<TBattlePlayer> = {
  ...
  fromJSON(object: any): TBattlePlayer {
    return {
      ...
      Index: isSet(object.Index) ? globalThis.Number(object.Index) : 0,
      FleetInfo: isSet(object.FleetInfo) ? TBattleFleet.fromJSON(object.FleetInfo) : undefined,
      OpenFunc: globalThis.Array.isArray(object?.OpenFunc) ? object.OpenFunc.map((e: any) => globalThis.Number(e)) : [],
...
export const TBattlePlayerList: MessageFns<TBattlePlayerList> = {
  ...
  fromPartial<I extends Exact<DeepPartial<TBattlePlayerList>, I>>(object: I): TBattlePlayerList {
    const message = createBaseTBattlePlayerList();
    message.BattlePlayerList = object.BattlePlayerList?.map((e) => TBattlePlayer.fromPartial(e)) || [];
    return message;
  },
};
...
export const TBattleShip: MessageFns<TBattleShip> = {
  ...
  fromJSON(object: any): TBattleShip {
    return {
      ...
      Level: isSet(object.Level) ? globalThis.Number(object.Level) : 0,
      Index: isSet(object.Index) ? globalThis.Number(object.Index) : 0,
      Attr: globalThis.Array.isArray(object?.Attr) ? object.Attr.map((e: any) => THeroAttr.fromJSON(e)) : [],
      CurHp: isSet(object.CurHp) ? globalThis.Number(object.CurHp) : 0,
      Equips: globalThis.Array.isArray(object?.Equips) ? object.Equips.map((e: any) => TBattleEquip.fromJSON(e)) : [],
      PSkill: globalThis.Array.isArray(object?.PSkill) ? object.PSkill.map((e: any) => TFiledPSkillLv.fromJSON(e)) : [],
      BathBuff: globalThis.Array.isArray(object?.BathBuff) ? object.BathBuff.map((e: any) => globalThis.Number(e)) : [],
...
export const TRandomFactor: MessageFns<TRandomFactor> = {
  ...
  fromJSON(object: any): TRandomFactor {
    return {
      Factors: globalThis.Array.isArray(object?.Factors) ? object.Factors.map((e: any) => globalThis.Number(e)) : [],
