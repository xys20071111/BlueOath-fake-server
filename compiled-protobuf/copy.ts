...
export const TArchiveCopyOperation: MessageFns<TArchiveCopyOperation> = {
  encode(message: TArchiveCopyOperation, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  create<I extends Exact<DeepPartial<TArchiveCopyOperation>, I>>(base?: I): TArchiveCopyOperation {
    return TArchiveCopyOperation.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<TArchiveCopyOperation>, I>>(object: I): TArchiveCopyOperation {
    const message = createBaseTArchiveCopyOperation();
...
function createBaseTBaseHeroInfo(): TBaseHeroInfo {
  return { HeroId: 0, Hp: 0, IsMvp: false, IsBattle: false, BreakStatus: 0, ExHeroInfo: [], OwnerUid: 0 };
}
...
export const TBaseInfo: MessageFns<TBaseInfo> = {
  ...
  fromJSON(object: any): TBaseInfo {
    return {
      ...
      IsRunningFight: isSet(object.IsRunningFight) ? globalThis.Boolean(object.IsRunningFight) : false,
      LBPoint: isSet(object.LBPoint) ? globalThis.Number(object.LBPoint) : 0,
      FirstPassTime: isSet(object.FirstPassTime) ? globalThis.Number(object.FirstPassTime) : 0,
      ...
      SfInfo: globalThis.Array.isArray(object?.SfInfo) ? object.SfInfo.map((e: any) => TSfInfo.fromJSON(e)) : [],
...
export const TCopyChooseSfLvArg: MessageFns<TCopyChooseSfLvArg> = {
  ...
  fromPartial<I extends Exact<DeepPartial<TCopyChooseSfLvArg>, I>>(object: I): TCopyChooseSfLvArg {
    const message = createBaseTCopyChooseSfLvArg();
    message.CopyId = object.CopyId ?? 0;
...
export const TCopyRes: MessageFns<TCopyRes> = {
  ...
  fromJSON(object: any): TCopyRes {
    return {
      ...
      Reward: globalThis.Array.isArray(object?.Reward) ? object.Reward.map((e: any) => TCommonReward.fromJSON(e)) : [],
    };
  },
...
export const TGetRandomFactorArg: MessageFns<TGetRandomFactorArg> = {
  ...
  fromPartial<I extends Exact<DeepPartial<TGetRandomFactorArg>, I>>(object: I): TGetRandomFactorArg {
    const message = createBaseTGetRandomFactorArg();
    message.CopyId = object.CopyId ?? 0;
    return message;
  },
...
export const TGetRandomFactorRet: MessageFns<TGetRandomFactorRet> = {
  ...
  fromJSON(object: any): TGetRandomFactorRet {
    return {
      Factors: globalThis.Array.isArray(object?.Factors)
        ...
        : [],
      LastRefreshTime: isSet(object.LastRefreshTime) ? globalThis.Number(object.LastRefreshTime) : 0,
  ...
  fromPartial<I extends Exact<DeepPartial<TGetRandomFactorRet>, I>>(object: I): TGetRandomFactorRet {
    const message = createBaseTGetRandomFactorRet();
...
export const TPassBaseArg: MessageFns<TPassBaseArg> = {
  ...
  fromJSON(object: any): TPassBaseArg {
    return {
      ...
      IsFlyAttack: isSet(object.IsFlyAttack) ? globalThis.Boolean(object.IsFlyAttack) : false,
      IsRunningFight: isSet(object.IsRunningFight) ? globalThis.Boolean(object.IsRunningFight) : false,
      ...
      Operation: isSet(object.Operation) ? TArchiveCopyOperation.fromJSON(object.Operation) : undefined,
      ...
      HerosInfo: globalThis.Array.isArray(object?.HerosInfo)
        ...
        : [],
      IsFinishMission: isSet(object.IsFinishMission) ? globalThis.Boolean(object.IsFinishMission) : false,
...
export const TPassBaseRet: MessageFns<TPassBaseRet> = {
  ...
  fromJSON(object: any): TPassBaseRet {
    return {
      Reward: globalThis.Array.isArray(object?.Reward) ? object.Reward.map((e: any) => TCommonReward.fromJSON(e)) : [],
      BattlePlayer: isSet(object.BattlePlayer) ? TBattlePlayer.fromJSON(object.BattlePlayer) : undefined,
  ...
  fromPartial<I extends Exact<DeepPartial<TPassBaseRet>, I>>(object: I): TPassBaseRet {
    ...
    message.BuildShipReward = object.BuildShipReward?.map((e) => TCommonReward.fromPartial(e)) || [];
...
function createBaseTQuitBaseArg(): TQuitBaseArg {
  return { CopyId: 0, IsRunningFight: false, IsPass: false, HeroInfo: [], VerifyPackage: undefined, BattleMode: 0 };
}
...
export const TQuitBaseArg: MessageFns<TQuitBaseArg> = {
  ...
  fromJSON(object: any): TQuitBaseArg {
    return {
      ...
      HeroInfo: globalThis.Array.isArray(object?.HeroInfo)
        ...
        : [],
      VerifyPackage: isSet(object.VerifyPackage) ? TVerifyPackage.fromJSON(object.VerifyPackage) : undefined,
  ...
  fromPartial<I extends Exact<DeepPartial<TQuitBaseArg>, I>>(object: I): TQuitBaseArg {
    ...
    message.VerifyPackage = (object.VerifyPackage !== undefined && object.VerifyPackage !== null)
...
export const TSfInfo: MessageFns<TSfInfo> = {
  ...
  fromJSON(object: any): TSfInfo {
    return {
      Type: isSet(object.Type) ? globalThis.Number(object.Type) : 0,
      Info: globalThis.Array.isArray(object?.Info) ? object.Info.map((e: any) => TSfStat.fromJSON(e)) : [],
    };
  },
...
export const TShipEquipGridInfo: MessageFns<TShipEquipGridInfo> = {
  ...
  fromPartial<I extends Exact<DeepPartial<TShipEquipGridInfo>, I>>(object: I): TShipEquipGridInfo {
    const message = createBaseTShipEquipGridInfo();
    message.HeroId = object.HeroId ?? 0;
...
export const TStartBaseArg: MessageFns<TStartBaseArg> = {
  ...
  fromJSON(object: any): TStartBaseArg {
    return {
      ...
      ExBuff: globalThis.Array.isArray(object?.ExBuff) ? object.ExBuff.map((e: any) => globalThis.Number(e)) : [],
...
export const TStartBaseHeroList: MessageFns<TStartBaseHeroList> = {
  ...
  fromPartial<I extends Exact<DeepPartial<TStartBaseHeroList>, I>>(object: I): TStartBaseHeroList {
    const message = createBaseTStartBaseHeroList();
...
export const TStartBaseRet: MessageFns<TStartBaseRet> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 11: {
          ...
          message.ShipEquipGridInfo.push(TShipEquipGridInfo.decode(reader, reader.uint32()));
          continue;
        }
        case 12: {
          if (tag !== 98) {
        ...
        case 15: {
          ...
          message.ExtraBattlePlayerList.push(TBattlePlayerList.decode(reader, reader.uint32()));
          continue;
        }
        case 16: {
          if (tag !== 130) {
  ...
  fromJSON(object: any): TStartBaseRet {
    return {
      BattlePlayer: isSet(object.BattlePlayer) ? TBattlePlayerList.fromJSON(object.BattlePlayer) : undefined,
      RandomSeed: isSet(object.RandomSeed) ? globalThis.Number(object.RandomSeed) : 0,
      Rid: isSet(object.Rid) ? globalThis.Number(object.Rid) : 0,
      arrRes: globalThis.Array.isArray(object?.arrRes) ? object.arrRes.map((e: any) => TCopyRes.fromJSON(e)) : [],
      ...
      AnimMode: isSet(object.AnimMode) ? globalThis.Number(object.AnimMode) : 0,
      WeatherGroupId: isSet(object.WeatherGroupId) ? globalThis.Number(object.WeatherGroupId) : 0,
  ...
  toJSON(message: TStartBaseRet): unknown {
    ...
    if (message.ShipEquipGridInfo?.length) {
      obj.ShipEquipGridInfo = message.ShipEquipGridInfo.map((e) => TShipEquipGridInfo.toJSON(e));
    }
    ...
    if (message.ExtraBattlePlayerList?.length) {
      obj.ExtraBattlePlayerList = message.ExtraBattlePlayerList.map((e) => TBattlePlayerList.toJSON(e));
    }
    if (message.Token !== undefined && message.Token !== "") {
  ...
  fromPartial<I extends Exact<DeepPartial<TStartBaseRet>, I>>(object: I): TStartBaseRet {
    ...
    message.IsRunningFight = object.IsRunningFight ?? false;
    message.ShipEquipGridInfo = object.ShipEquipGridInfo?.map((e) => TShipEquipGridInfo.fromPartial(e)) || [];
    ...
    message.Verify = (object.Verify !== undefined && object.Verify !== null)
      ...
      : undefined;
    message.ExtraBattlePlayerList = object.ExtraBattlePlayerList?.map((e) => TBattlePlayerList.fromPartial(e)) || [];
